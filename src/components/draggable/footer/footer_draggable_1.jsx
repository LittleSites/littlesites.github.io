...
import './footer_draggable_1.css';

const Footer_draggable_1 = (
  { tel = '1 234 567 8901',
    location = 'https://www.google.es/maps',
  ...
  return (
    <footer style={style} className="footer_draggable_1">
...
export default Footer_draggable_1;